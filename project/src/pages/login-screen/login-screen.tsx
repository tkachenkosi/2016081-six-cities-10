          ...
          <section className="login">
            ...
            <form onSubmit={handleSubmit} className="login__form form" action="#" method="post">
              <div className="login__input-wrapper form__input-wrapper">
                ...
                <input ref={loginRef} className="login__input form__input" data-testid="email" type="email" name="email" placeholder="Email" required />
              </div>
              <div className="login__input-wrapper form__input-wrapper">
                <label className="visually-hidden">Password</label>
                <input ref={passwdRef} className="login__input form__input" data-testid="password" type="password" name="password" placeholder="Password (цифры + лат.буквы, > 5сим.)" required />
              </div>
